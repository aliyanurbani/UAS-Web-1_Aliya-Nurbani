...
<body class="bg-light">
    ...
    top: 0 !important; z-index : 99999 !important;">
        <div class="container-fluid container">
            <a class="navbar-brand" href="#">Web kucatat</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary ms-md-4 text-white" href="../index.html">Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-5">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Aplikasi web ini menyediakan antarmuka pengguna yang modern dan ramah pengguna, memungkinkan Anda sebagai dosen untuk dengan mudah memasukkan data mahasiswa Anda. Dengan fitur validasi data, otorisasi yang kuat, dan perlindungan keamanan data, Anda dapat merasa aman dan nyaman saat menggunakan aplikasi ini. Antarmuka yang responsif dan dukungan pelanggan yang baik juga memastikan pengalaman pengguna yang lancar dan efisien.</p>
